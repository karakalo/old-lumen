...
is
   ...
   type void_Ptr_array is
     array (Interfaces.C.size_t range <>) of aliased void_Ptr;
   ...
   type Display_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.Display;
   ...
   type NativeWindowType_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.NativeWindowType;
   ...
   type NativePixmapType_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.NativePixmapType;
   ...
   type EGLint_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLint;
   ...
   type EGLBoolean_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLBoolean;
   ...
   type EGLenum_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLenum;
   ...
   type EGLConfig_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLConfig;
   ...
   type EGLContext_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLContext;
   ...
   type EGLDisplay_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLDisplay;
   ...
   type EGLSurface_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLSurface;
   ...
   type EGLClientBuffer_array is
     array (Interfaces.C.size_t range <>) of aliased eGL.EGLClientBuffer;
