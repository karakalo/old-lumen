...
with Swig;
with eGL.Pointers;
with eGL.NativeDisplayType;
with Interfaces.C.Pointers;
with Interfaces.C.Strings;
with System;
package eGL.Binding is
...
private
   ...
   pragma Import (C, eglGetError, "Ada_eglGetError");
   pragma Import (C, eglGetDisplay, "Ada_eglGetDisplay");
   pragma Import (C, eglInitialize, "Ada_eglInitialize");
   pragma Import (C, eglTerminate, "Ada_eglTerminate");
   pragma Import (C, eglQueryString, "Ada_eglQueryString");
   ...
   pragma Import (C, eglCreatePbufferSurface, "Ada_eglCreatePbufferSurface");
   pragma Import (C, eglCreatePixmapSurface, "Ada_eglCreatePixmapSurface");
   pragma Import (C, eglDestroySurface, "Ada_eglDestroySurface");
   pragma Import (C, eglQuerySurface, "Ada_eglQuerySurface");
   pragma Import (C, eglBindAPI, "Ada_eglBindAPI");
   pragma Import (C, eglQueryAPI, "Ada_eglQueryAPI");
   pragma Import (C, eglWaitClient, "Ada_eglWaitClient");
   pragma Import (C, eglReleaseThread, "Ada_eglReleaseThread");
   pragma Import
     (C,
      eglCreatePbufferFromClientBuffer,
      "Ada_eglCreatePbufferFromClientBuffer");
   pragma Import (C, eglSurfaceAttrib, "Ada_eglSurfaceAttrib");
   pragma Import (C, eglBindTexImage, "Ada_eglBindTexImage");
   pragma Import (C, eglReleaseTexImage, "Ada_eglReleaseTexImage");
   pragma Import (C, eglSwapInterval, "Ada_eglSwapInterval");
   pragma Import (C, eglCreateContext, "Ada_eglCreateContext");
   pragma Import (C, eglDestroyContext, "Ada_eglDestroyContext");
   pragma Import (C, eglMakeCurrent, "Ada_eglMakeCurrent");
   pragma Import (C, eglGetCurrentContext, "Ada_eglGetCurrentContext");
   pragma Import (C, eglGetCurrentSurface, "Ada_eglGetCurrentSurface");
   pragma Import (C, eglGetCurrentDisplay, "Ada_eglGetCurrentDisplay");
   pragma Import (C, eglQueryContext, "Ada_eglQueryContext");
   pragma Import (C, eglWaitGL, "Ada_eglWaitGL");
   pragma Import (C, eglWaitNative, "Ada_eglWaitNative");
   pragma Import (C, eglSwapBuffers, "Ada_eglSwapBuffers");
   pragma Import (C, eglCopyBuffers, "Ada_eglCopyBuffers");
   pragma Import (C, eglGetProcAddress, "Ada_eglGetProcAddress");
